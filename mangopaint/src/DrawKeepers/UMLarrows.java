 ...
 * @author eparr
 */
public abstract class UMLarrows implements Serializable {
...
class aCIR extends UMLarrows{  //poneme el circulo
    ...
    void showarrow(Graphics g) {
       ...
       g.setColor(Color.WHITE);
       g.fillOval(xo - P, ya - P, P+P, P+P);
       g.setColor(Color.BLACK);
       g.drawOval(xo - P, ya - P, P+P, P+P);
       g.drawOval(xo - P+1, ya - P+1, P+P, P+P);
...
class aCOM extends UMLarrows{  //
    ...
    void showarrow(Graphics g) {
       ...
       if(oneDirection() == 1){
           ...
           poly.addPoint(xo,ya);
           poly.addPoint(xo+P,ya+P+P);
           poly.addPoint(xo,ya+P+P+P+P);
           poly.addPoint(xo-P,ya+P+P);
          // poly.addPoint(xo, ya);
       ...
       if(oneDirection() == 2){
            poly.addPoint(xo,ya);
           poly.addPoint(xo-P-P,ya-P);
           poly.addPoint(xo-P-P-P-P,ya);
           poly.addPoint(xo-P-P,ya+P);
